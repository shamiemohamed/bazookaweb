...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Bazooka.My "Marketing" Product Page</title>
                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img" src="http://www1.park.com.br/park/pt/imagens/geral/marca-barra-vila-rica-hotel.png" alt="Bazooka Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 sm-margin-b-60">
                        <div class="margin-b-30">
                            <h1 class="promo-block-title text-danger">Medigion Power</h1>
                            <p class="promo-block-text text-danger">Daya kekuatan minda yang luar biasa</p>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="promo-block-img-wrap">
                            <img class="promo-block-img img-responsive" src="http://www.macdaveautopaint.com/images/products/1.png" align="Avatar">
                        </div>
                    </div>
                </div>
                <!--// end row -->
            ...
            <div class="container content-lg">
                <div class="row">
                    <div class="col-sm-5 sm-margin-b-60">
                        <img class="full-width img-responsive" src="http://tigonpharma.com/images/products/2016/08/12/original/mass-plus-help-in-weight-growth-and-muscle-building-1470965214.png" alt="Image">
                    </div>
                    <div class="col-sm-7">
