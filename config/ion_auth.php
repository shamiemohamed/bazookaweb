...
*/
$config['tables']['users']           = 'ci_users';
$config['tables']['groups']          = 'ci_groups';
$config['tables']['users_groups']    = 'ci_users_groups';
 ...
 */
$config['site_title']                 = "bazooka.my";       // Site Title, example.com
$config['admin_email']                = "noreply@bazooka.my"; // Admin Email, admin@example.com
